...
from src.app.account.auth.views import router as auth_router  # noqa: E402;
from src.app.account.users.views import router as users_router  # noqa: E402;
from src.app.operations.views import router as operations_router  # noqa: E402;
